...
/**
 * Created by utkarsh on 16/02/18.
 */
...
*/
    ...
    static class BinarySearchTree {
      ...
      Node findInOrderSuccessor(Node inputNode) {
        ...
        if(null == inputNode) return null;

        //in case of right subtree it is leftmost element

        Node rightTree = inputNode.right;

        if(null==rightTree){
          Node parent=inputNode.parent;
          while(parent!=null && parent.key<inputNode.key){
